...
public class MailingAddressView {
	...
	public MailingAddressView(String fullName, String typeOfAddress, String houseNumber, String streetNuber,
	...
	public String toString() {
		return "MailingAddressView [fullName=" + fullName + ", typeOfAddress=" + typeOfAddress + ", houseNumber="
